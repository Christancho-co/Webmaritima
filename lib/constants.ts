...
export const NAV_LINKS = [
  { label: 'Recreational', href: '/recreational', sublabel: 'Lifestyle Series' },
  { label: 'Work', href: '/work', sublabel: 'Professional Series' },
  { label: 'Military Grade', href: '/military', sublabel: 'Defense & Tactical' },
  { label: 'Special Projects', href: '/special-projects', sublabel: 'Custom Engineering' },
