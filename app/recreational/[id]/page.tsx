// app/recreational/[id]/page.tsx  (o donde tengas este archivo)
// Ajusta la ruta del archivo al nombre/ubicación real en tu proyecto.
...
export default function RecreationalDetailPage({
  ...
  // Extraer solo el número del nombre (ej. "MT-31 Hunter" -> "31")
  const numberMatch = (model.name || '').match(/\d+/);
  const displayNumber = numberMatch
    ? numberMatch[0]
    : (model.name || '').replace(/MT[- ]?/i, '').trim() || model.name;
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
          ...
          <div className="space-y-4">
            ...
            <div className="relative aspect-[4/3] rounded-xl overflow-hidden bg-black/20">
              ...
              {/* Número superpuesto — AHORA muestra SOLO el número */}
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              {/* Mostrar SOLO el número en el título principal también */}
