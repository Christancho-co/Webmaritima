...
export default function MilitaryPage() {
  ...
  const { models } = BOAT_MODELS.military;
    ...
    <div className="min-h-screen bg-[#001F3F]">
      ...
      <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image
            src="/images/military/hero-military.jpg"
            alt="Military Boats"
            fill
            ...
            {models.map((model) => (
              ...
              >
                ...
                <div className="relative aspect-[4/3] overflow-hidden">
                  ...
                  {/* Nombre completo superpuesto en monument */}
                  <div className="absolute bottom-4 left-4 z-10 leading-none select-none">
                    <span className="font-metag text-white text-[28px] md:text-[36px] leading-tight opacity-90 group-hover:opacity-100 transition-opacity tracking-wider block">
      ...
      <section className="py-20 border-t border-white/10">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="font-monument text-2xl sm:text-3xl md:text-4xl text-white tracking-wider mb-6">
            {language === 'en'
              ? 'DEFENSE SOLUTIONS FOR YOUR MISSION'
              : 'SOLUCIONES DE DEFENSA PARA TU MISION'}
          </h2>
          <p className="text-white/60 text-base md:text-lg mb-10 font-sans px-4">
            {language === 'en'
              ? 'Contact our defense team for classified specifications and government pricing.'
              : 'Contacta a nuestro equipo de defensa para especificaciones y precios gubernamentales.'}
          </p>
